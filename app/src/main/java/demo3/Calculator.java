...
public class Calculator {
    ...
    public static double calculate(double amount, double totalValue, String operand) {
        ...
        // System.out.println(previousCurrent + " " + userOperand + " " + userNumber + "
        // = " + result);
    ...
    // System.out.print("Enter your operand or press c to clear: ");
    // } else {
    // System.out.println("Please an enter an operand[+, -, *, /] or press c to
    // clear or q quit");
    // }
